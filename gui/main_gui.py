...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionR_sidence = QAction(MainWindow)
        self.actionR_sidence.setObjectName(u"actionR_sidence")
        self.actionR_servation = QAction(MainWindow)
        self.actionR_servation.setObjectName(u"actionR_servation")
        ...
        self.menuFichier.addSeparator()
        self.menuFichier.addAction(self.actionR_sidence)
        self.menuFichier.addAction(self.actionR_servation)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionR_sidence.setText(QCoreApplication.translate("MainWindow", u"R\u00e9sidence", None))
        self.actionR_servation.setText(QCoreApplication.translate("MainWindow", u"R\u00e9servation", None))
